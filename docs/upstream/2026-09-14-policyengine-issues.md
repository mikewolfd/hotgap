...
| https://github.com/PolicyEngine/policyengine-us/pull/9499 — 2026 Idaho parent Medicaid limit 0.27 → 0.21 (IDAPA 16.03.01.411, $365/month for three) | #9474 | open, stacked on #9475 at the maintainer's invitation; Idaho is an expansion state so this moves the category, not coverage — no HotGap override needed. |
