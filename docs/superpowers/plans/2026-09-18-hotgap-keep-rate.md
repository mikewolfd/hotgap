...
**What it says today (single parent of two):** the **national mean keep rate is −1¢** — a family that doubles its earnings from poverty ends up, on average, where it started. Most regressive: Nebraska −70¢, Missouri −63¢, Iowa −60¢, Georgia −51¢, Ohio −48¢, every one driven by child-care help ending (Missouri: $17,040 → $0 at $40,000 → $41,000; net income $61,364 → $44,936). Least regressive: New Mexico 30¢, Washington 28¢, DC 25¢, Virginia 24¢. On this measure Massachusetts ranks 33rd and Maryland 38th. Between 50% and 74% of families like this earn less than twice poverty, depending on the state: this is where they live.
...
- [ ] **The state readout leads with the road sentence** for every measure: *"Missouri — a single parent of two who earns their way from poverty to twice poverty ends up 63¢ poorer for every extra dollar. The road collapses at $40,000, where child-care help ends and the family loses $16,428 in one step. 6 in 10 families like this in Missouri earn less than that."* Then the selected measure's own sentence where it is not the keep rate; then the whole-axis worst as the last line, labeled: *"Largest single loss anywhere on the curve: $10,370 at $118,000 — 87 in 100 families like this earn less."*
