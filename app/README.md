...
|---|---|---|---|
| `index.html` | citizen | `src/citizen/main.ts` — mounts the editor and the result (`src/citizen/result.ts`; the pure modules beside it render every component `design/inventory.md` assigns to the surface, from one `HouseholdEvaluation`) | built, picture first since 2026-09-18; proofs `e2e/citizen.spec.ts` |
...
**The order on every page** (`design/PICTURE-FIRST-2026-09-18.md`,
...
it was written (2026-09-17), the date it was redrafted to the new citizen
register (2026-09-18) and `reviewed: null`. Three native readers have since
read the citizen page and named three phrases that sounded machine-written;
those are fixed (`design/REVIEW-picture-first-citizen-2026-09-18.md`), which
is a reading, not a review. It was drafted by the model
