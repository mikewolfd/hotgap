...
export const copy = {
  ...
  assumed: {
    ...
    youDisabled: " You have a disability.",
    spouseDisabled: " Your spouse has a disability.",
    kidDisabled: " One of your kids has a disability.",
    kidsDisabled: " {n} of your kids have a disability.",
