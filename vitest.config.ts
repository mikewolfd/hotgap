...
// unit tests. `tsc -b` (npm run typecheck) emits compiled copies of every test
// into */dist/, which vitest ≥3 no longer skips by default.
//
...
export default defineConfig({
  test: { exclude: [...configDefaults.exclude, "**/.claude/worktrees/**", "**/dist/**", "app/e2e/**"], env: { TZ: "America/New_York" } },
});
