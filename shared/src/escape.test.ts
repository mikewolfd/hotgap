...
describe("escapeAnalysis on the real CA fixture", () => {
  it("computes verified safe exit, leap, and program thresholds", () => {
    ...
    expect(esc.safeExitEarnings).toBe(64000);
    expect(esc.leap).toBe(34000);
...
describe("escapeAnalysis on synthetic curves", () => {
  ...
  it("omits a program from programEnds if it is still received at the last point", () => {
    ...
    const pts = [
      { earnings: 0, netIncome: 10000, programs: { snap: 500, medicaid: 0, chip: 0, eitc: 0, ctc: 0, aca: 0, tanf: 0, housing: 0, wic: 0, ssi: 0, headstart: 0, schoolmeals: 0 } },
      { earnings: 10000, netIncome: 11000, programs: { snap: 400, medicaid: 0, chip: 0, eitc: 0, ctc: 0, aca: 0, tanf: 0, housing: 0, wic: 0, ssi: 0, headstart: 0, schoolmeals: 0 } },
      { earnings: 20000, netIncome: 12000, programs: { snap: 200, medicaid: 0, chip: 0, eitc: 0, ctc: 0, aca: 0, tanf: 0, housing: 0, wic: 0, ssi: 0, headstart: 0, schoolmeals: 0 } },
    ];
    const esc = escapeAnalysis(pts);
  ...
  it("correctly identifies when multiple programs have different end points", () => {
    ...
    const pts = [
      { earnings: 0, netIncome: 10000, programs: { snap: 300, tanf: 200, medicaid: 0, chip: 0, eitc: 0, ctc: 0, aca: 0, housing: 0, wic: 0, ssi: 0, headstart: 0, schoolmeals: 0 } },
      { earnings: 10000, netIncome: 11000, programs: { snap: 200, tanf: 200, medicaid: 0, chip: 0, eitc: 0, ctc: 0, aca: 0, housing: 0, wic: 0, ssi: 0, headstart: 0, schoolmeals: 0 } },
      { earnings: 20000, netIncome: 12000, programs: { snap: 150, tanf: 0, medicaid: 0, chip: 0, eitc: 0, ctc: 0, aca: 0, housing: 0, wic: 0, ssi: 0, headstart: 0, schoolmeals: 0 } },
      { earnings: 30000, netIncome: 13000, programs: { snap: 0, tanf: 0, medicaid: 0, chip: 0, eitc: 0, ctc: 0, aca: 0, housing: 0, wic: 0, ssi: 0, headstart: 0, schoolmeals: 0 } },
    ];
    const esc = escapeAnalysis(pts);
