// Builds core/data/zip5-county.json: 5-digit ZIP (ZCTA) -> dominant county FIPS.
...
writeFileSync(new URL("../core/data/zip5-county.json", import.meta.url), JSON.stringify(table));
